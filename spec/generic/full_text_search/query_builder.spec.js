...
describe('query builder', () => {
  ...
  it('BaseQuery', done => {
    ...
    expect(() => new Query.BaseQuery("custom").boost("1")).not.toThrowErrorOfType("TypeError");
  ...
  it('MatchQuery', done => {
    ...
    expect(() => q.minimumShouldMatch("4")).not.toThrowErrorOfType("TypeError");
    expect(() => q.minimumShouldMatch("a")).toThrowErrorOfType("TypeError");
    ...
    expect(() => q.fuzziness(-3)).toThrowErrorOfType("TypeError");
    expect(() => q.fuzziness("3")).not.toThrowErrorOfType("TypeError");
    expect(() => q.fuzziness("x")).toThrowErrorOfType("TypeError");
    expect(() => q.prefixLength(-1)).toThrowErrorOfType("TypeError");
    expect(() => q.prefixLength("1")).not.toThrowErrorOfType("TypeError");
    expect(() => q.prefixLength("--1")).toThrowErrorOfType("TypeError");
  ...
  it('QueryBuilder', done => {
    ...
    expect(() => new Query.QueryBuilder().enableFinalScoring("false")).not.toThrowErrorOfType("TypeError");
    expect(() => new Query.QueryBuilder().enableFinalScoring("f")).toThrowErrorOfType("TypeError");
