...
class Collection extends __WEBPACK_IMPORTED_MODULE_0__event_emitter__["a" /* LokiEventEmitter */] {
	...
	constructor(name, options) {
		...
		if (__WEBPACK_IMPORTED_MODULE_7__loki__["Loki"].Plugins.FullTextSearch !== undefined) {
			this._fullTextSearch = options.hasOwnProperty('fullTextSearch')
				? new (__WEBPACK_IMPORTED_MODULE_7__loki__["Loki"].Plugins.FullTextSearch)(options.fullTextSearch) : null;
		}
