...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__resultset__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__helper__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__loki__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__memory_adapter__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fs_adapter__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__local_storage_adapter__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__collection__ = __webpack_require__(1);
...
class Loki extends __WEBPACK_IMPORTED_MODULE_0__event_emitter__["a" /* LokiEventEmitter */] {
	...
	initializePersistence(options = {}) {
		...
		const persistenceMethods = {
			'fs': __WEBPACK_IMPORTED_MODULE_2__fs_adapter__["a" /* LokiFsAdapter */],
			'localStorage': __WEBPACK_IMPORTED_MODULE_3__local_storage_adapter__["a" /* LokiLocalStorageAdapter */],
			'memory': __WEBPACK_IMPORTED_MODULE_1__memory_adapter__["a" /* LokiMemoryAdapter */]
		};
	...
	addCollection(name, options) {
		const collection = new __WEBPACK_IMPORTED_MODULE_4__collection__["a" /* Collection */](name, options);
	...
	removeCollection(collectionName) {
		...
		for (i = 0; i < len; i += 1) {
			if (this.collections[i].name === collectionName) {
				const tmpcol = new __WEBPACK_IMPORTED_MODULE_4__collection__["a" /* Collection */](collectionName, {});
	...
	loadJSONObject(dbObject, options) {
		...
		function makeLoader(coll) {
			...
			if (collOptions.proto) {
				inflater = collOptions.inflate || __WEBPACK_IMPORTED_MODULE_5__utils__["a" /* copyProperties */];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__clone__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__collection__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helper__ = __webpack_require__(5);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LokiMemoryAdapter;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__event_emitter__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resultset__ = __webpack_require__(7);
...
class DynamicView extends __WEBPACK_IMPORTED_MODULE_0__event_emitter__["a" /* LokiEventEmitter */] {
	...
	evaluateDocument(objIndex, isNew) {
		...
		const evalResultset = new __WEBPACK_IMPORTED_MODULE_1__resultset__["a" /* Resultset */](this.collection);
