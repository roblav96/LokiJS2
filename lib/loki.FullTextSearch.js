...
class Tokenizer {
	...
	setSplitter(label, func) {
		...
		if (!__WEBPACK_IMPORTED_MODULE_0__utils_js__["f" /* isFunction */](func)) {
	...
	_getPosition(labelFunc) {
		if (__WEBPACK_IMPORTED_MODULE_0__utils_js__["f" /* isFunction */](labelFunc)) {
			return this._queue.indexOf(labelFunc);
		} else if (__WEBPACK_IMPORTED_MODULE_0__utils_js__["g" /* isConvertibleToString */](labelFunc)) {
...
/* harmony export (immutable) */ __webpack_exports__["g"] = isConvertibleToString;
...
class WildcardQuery extends BaseQuery {
	...
	enableScoring(enable) {
		this._data.enable_scoring = __WEBPACK_IMPORTED_MODULE_0__utils_js__["d" /* asBoolean */](enable);
		return this;
	}
}
...
class FuzzyQuery extends BaseQuery {
	 ...
	 */
	fuzziness(fuzziness) {
		if ((!__WEBPACK_IMPORTED_MODULE_0__utils_js__["e" /* isString */](fuzziness) || fuzziness !== "AUTO") && (!__WEBPACK_IMPORTED_MODULE_0__utils_js__["b" /* isNumber */](fuzziness) || fuzziness < 0)) {
...
class MatchQuery extends BaseQuery {
	 ...
	 */
	fuzziness(fuzziness) {
		if (!__WEBPACK_IMPORTED_MODULE_0__utils_js__["e" /* isString */](fuzziness) || fuzziness !== "AUTO") {
...
class QueryBuilder {
	...
	enableFinalScoring(enable) {
		this._data.final_scoring = __WEBPACK_IMPORTED_MODULE_0__utils_js__["d" /* asBoolean */](enable);
		return this;
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__support_js__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tokenizer__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__queries__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__language_de__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__inverted_index__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__scorer__ = __webpack_require__(4);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DE", function() { return __WEBPACK_IMPORTED_MODULE_3__language_de__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "InvertedIndex", function() { return __WEBPACK_IMPORTED_MODULE_4__inverted_index__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Scorer", function() { return __WEBPACK_IMPORTED_MODULE_5__scorer__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scorer__ = __webpack_require__(4);
