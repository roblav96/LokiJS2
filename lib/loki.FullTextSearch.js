(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("FullTextSearch", ["Loki"], factory);
	else if(typeof exports === 'object')
		exports["FullTextSearch"] = factory(require("Loki"));
	else
		root["Loki"] = root["Loki"] || {}, root["Loki"]["FullTextSearch"] = factory(root["Loki"]);
...
class InvertedIndex {
	 ...
	 */
	constructor(fieldName, tokenizer = new __WEBPACK_IMPORTED_MODULE_0__tokenizer__["a" /* Tokenizer */]) {
		...
		if (Array.isArray(fields)) {
			for (let i = 0; i < fields.length; i++) {
				...
				if (tokenizer !== undefined) {
					if (!(tokenizer instanceof __WEBPACK_IMPORTED_MODULE_2__tokenizer__["a" /* Tokenizer */])) {
				...
				this._invIdxs[field.name] = new __WEBPACK_IMPORTED_MODULE_0__inverted_index__["a" /* InvertedIndex */](name, tokenizer);
			}
		} else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Loki__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Loki___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_Loki__);





__WEBPACK_IMPORTED_MODULE_3_Loki___default.a.Tokenizer = __WEBPACK_IMPORTED_MODULE_1__tokenizer__["a" /* Tokenizer */];
__WEBPACK_IMPORTED_MODULE_3_Loki___default.a.QueryBuilder = __WEBPACK_IMPORTED_MODULE_2__queries__["a" /* QueryBuilder */];
__WEBPACK_IMPORTED_MODULE_3_Loki___default.a.Plugins.FullTextSearch = __WEBPACK_IMPORTED_MODULE_0__full_text_search__["a" /* FullTextSearch */];
