...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loki = __webpack_require__(1);
	
	var _loki2 = _interopRequireDefault(_loki);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	module.exports = _loki2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Collection extends _event_emitter.LokiEventEmitter {
		...
		constructor(name, options) {
			...
			if (_loki2.default.Plugins.FullTextSearch !== undefined) {
				this._fullTextSearch = options.hasOwnProperty('fullTextSearch') ? new _loki2.default.Plugins.FullTextSearch(options.fullTextSearch) : null;
			}
