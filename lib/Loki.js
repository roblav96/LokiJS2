...
/***/ function(module, exports, __webpack_require__) {
	...
	_plugin.Plugin.initialize(_lokicore.Loki);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Collection extends _event_emitter.LokiEventEmitter {
		...
		constructor(name, options) {
			...
			if (_plugin.Plugin.load("FullTextSearch") !== undefined) {
				this._fullTextSearch = options.hasOwnProperty('fullTextSearch') ? new (_plugin.Plugin.load("FullTextSearch"))(options.fullTextSearch) : null;
			}
