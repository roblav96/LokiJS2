(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["LokiModules"] = root["LokiModules"] || {}, root["LokiModules"]["fts"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _full_text_search = __webpack_require__(1);
	
	var _plugin = __webpack_require__(8);
	
	var _tokenizer = __webpack_require__(3);
	
	_plugin.Plugin.register("FullTextSearch", _full_text_search.FullTextSearch);
	_plugin.Plugin.register("Tokenizer", _tokenizer.Tokenizer, true);
	
	module.exports = _full_text_search.FullTextSearch;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inverted_index = __webpack_require__(2);
	
	var _index_searcher = __webpack_require__(5);
			...
			if (Array.isArray(fields)) {
				for (let i = 0; i < fields.length; i++) {
					...
					if (tokenizer !== undefined) {
						if (!(tokenizer instanceof _tokenizer.Tokenizer)) {
							throw new TypeError("Field tokenizer needs to be a instance of tokenizer.");
						}
					} else {
						tokenizer = new _tokenizer.Tokenizer();
					}
					this._invIdxs[field.name] = new _inverted_index.InvertedIndex(name, tokenizer);
				}
			} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	class InvertedIndex {
	  ...
	  */
		constructor(fieldName, tokenizer = new _tokenizer.Tokenizer()) {
...
/***/ function(module, exports) {
	...
	exports.asArrayOfString = asArrayOfString;
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scorer = __webpack_require__(6);
				...
				case "terms":
					{
						for (let i = 0; i < query.value.length; i++) {
							let termIdx = _inverted_index.InvertedIndex.getTermIndex(query.value[i], root);
	  ...
	  */
		_recursive(root, idx = 0, term = '', escaped = false) {
			...
			if (!escaped && this._wildcard[idx] === '\\') {
				...
				let all = _inverted_index.InvertedIndex.extendTermIndex(root);
			...
			for (let i = 0, docId; i < docs.length, docId = docs[i]; i++) {
				...
				for (let j = 0; j < docResults[docId].length; j++) {
					...
					switch (docResult.type) {
						case 'BM25':
							{
								let fieldLength = this._invIdxs[docResult.fieldName].documentStore[docId].fieldLength / Math.pow(this._invIdxs[docResult.fieldName].documentStore[docId].boost, 2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.QueryBuilder = exports.BoolQuery = exports.ConstantScoreQuery = exports.MatchAllQuery = exports.MatchQuery = exports.ExistsQuery = exports.PrefixQuery = exports.FuzzyQuery = exports.WildcardQuery = exports.TermsQuery = exports.TermQuery = exports.BaseQuery = undefined;
...
;
//# sourceMappingURL=Loki.fts.js.map